...
import { ChevronLeft, ChevronRight, Search, Heart, Gift, Bell, BellOff, Users } from "lucide-react-native";
...
export default function CalendarScreen({ 
  ...
  // Mock events - replace with real data from friends
  const events = [
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.bg }]}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        {/* Find Friends Button */}
        <TouchableOpacity 
          style={[styles.findFriendsBtn, { backgroundColor: theme.card, borderColor: theme.border }]}
          onPress={() => onNavigate?.('search_users')}
        >
          <Users size={18} color={theme.primary} />
          <Text style={[styles.findFriendsText, { color: theme.text }]}>Find Friends to Celebrate</Text>
        </TouchableOpacity>
              ...
              <View key={event.id} style={[styles.eventCard, { backgroundColor: theme.card, borderColor: theme.border, marginBottom: 12 }]}>
                ...
                <View style={styles.eventActions}>
                  {event.userId && onToggleReminder && (
                    <TouchableOpacity 
                      onPress={() => onToggleReminder(event.userId!)}
                  ...
                  <TouchableOpacity 
                    onPress={() => onWishClick?.(nameBase, event.userId)}
                    style={[styles.smallAction, { backgroundColor: theme.itemBg }]}
                  >
